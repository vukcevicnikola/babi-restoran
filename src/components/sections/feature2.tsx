      ...
      <div className="max-w-9xl container">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {LOCATIONS.map((location, i) => (
            <FadeInSection key={location.city} delay={200 + i * 100}>
              <Card className="group ring-secondary/30 relative overflow-hidden border-none bg-transparent ring-1 shadow-none">
